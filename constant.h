...
#define IN1_PIN 3 //仮置き
#define IN2_PIN 2 //仮置き
...
#define COUNT_LIGHT1_LOOP_THRE 15 //上に同じ
#define LIGHT2_THRE 200 //放出検知のための閾値
#define COUNT_LIGHT2_LOOP_THRE 15 //上に同じ
#define ACC_THRE 1//着地検知のための閾値
#define COUNT_ACC_LOOP_THRE 40 //上に同じ
