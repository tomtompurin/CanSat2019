...
class Radio{
  ...
  XBee manager;
  uint8_t payload[90];
//  XBeeAddress64 addr64 = XBeeAddress64(0x13A200, 0x4154CBE0);// 実際の送信先64bitアドレスを記入します。(ここもxBee毎に固有の値、地上局のXbeeのアドレス) // 1機目
  XBeeAddress64 addr64 = XBeeAddress64(0x13A200, 0x41917AF6);// 実際の送信先64bitアドレスを記入します。(ここもxBee毎に固有の値、地上局のXbeeのアドレス) // 2機目
